...
public class Constant {
    ...
    @Value("${another.redis-key.search-course}")
    public String SEARCH_COURSE_REDIS_KEY;
    @Value("${another.redis-key.search-chapter}")
    public String SEARCH_CHAPTER_REDIS_KEY;
    @Value("${another.redis-key.search-subsection}")
    public String SEARCH_SUBSECTION_REDIS_KEY;
    @Value("${another.redis-key.message-interceptor}")
